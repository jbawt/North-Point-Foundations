 ...
 *
 * Optional: set `VITE_NETLIFY_FORM_ACTION` to override the form POST URL. If omitted, posts to
 * `import.meta.env.BASE_URL` (typical for the site and forms on the same Netlify site).
 */
